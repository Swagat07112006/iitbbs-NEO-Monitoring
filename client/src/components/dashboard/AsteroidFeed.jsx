...
const AsteroidFeed = () => {
  ...
  return (
    <div className="bg-[#09090b] border border-white/10 rounded-2xl overflow-hidden flex flex-col h-full">
      {/* Header */}
      <div className="p-6 border-b border-white/10 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
           <h2 className="text-xl font-bold text-white">Live Asteroid Feed</h2>
           <p className="text-gray-400 text-sm">Real-time data from NASA NeoWs API</p>
        </div>
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <div className="relative flex-1 md:w-64">
            ...
            <input 
              ...
              className="w-full bg-black border border-white/10 rounded-lg pl-9 pr-4 py-2 text-sm text-white focus:border-cyan-500 focus:outline-none transition-colors"
            />
          </div>
          ...
          neos.map((neo) => (
            <div key={neo.id} className="grid grid-cols-12 gap-4 px-4 py-4 items-center rounded-lg hover:bg-white/5 transition-colors group">
              ...
              <div className="col-span-1 flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                <button className="p-1 hover:text-cyan-400 text-gray-500 transition-colors">
